        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
                ...
                <div className="container relative z-10 px-4 text-center text-white space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-1000">
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight">
                        Make Your <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-rose-400">Automotive Dream</span> Come True
                    </h1>
                    <p className="text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto font-light">
                        Premium vehicle trading, lifecycle management, and secure transactions — all in one platform.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
                        <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 transition-all duration-300 font-semibold shadow-lg" asChild>
                            <Link to="/vehicles">Browse Inventory <ArrowRight className="ml-2 h-5 w-5" /></Link>
                        </Button>
                        <Button size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full border-white/30 text-black dark:text-white font-bold hover:bg-white/10 hover:text-white hover:scale-105 transition-all duration-300 backdrop-blur-sm" asChild>
            ...
            <section className="py-24 bg-background">
                <div className="container px-4 mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="p-8 rounded-2xl bg-card border shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                            <div className="h-12 w-12 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-6 transition-transform duration-300 group-hover:scale-110">
            ...
            <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
                <div className="container px-4 mx-auto text-center relative z-10">
                    ...
                    <Button size="lg" variant="secondary" className="h-14 px-8 text-lg rounded-full shadow-lg hover:scale-105 hover:bg-secondary/90 transition-all duration-300" asChild>
